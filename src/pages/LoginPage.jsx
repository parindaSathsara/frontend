        ...
        <div className="w-full max-w-md">
          ...
          <div className="grid grid-cols-1 gap-4">
            <button 
              ...
              disabled={loading}
              type="button"
              className="flex items-center justify-center gap-3 py-3 border border-luxury-silver/30 text-luxury-black hover:border-gold-500 hover:bg-gold-50 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
